...
/**
 * Add a widget to display a portfolio
 *
 * @since 1.0
 * @package Excellent Engineering Portfolio
 */
class eepWidgetPortfolio extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct(
			'eep_widget_portfolio',
			__('Excellent Engineering Portfolio', 'textdomain'),
			array( 'description' => __( 'Display your portfolio.', 'textdomain' ), )
		);
	...
	public function widget( $args, $instance ) {
		...
		echo eep_portfolio_shortcode( $atts );
